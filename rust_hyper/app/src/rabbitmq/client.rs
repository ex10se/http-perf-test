...
use super::queues::{EXCHANGE_NAME, QUEUE_HYPER, QUEUE_SYSTEM_HYPER};
...
impl RabbitClient {
    ...
    pub async fn declare_queues(&self) -> Result<(), Box<dyn std::error::Error>> {
        ...
        info!("Queue '{}' declared and bound", QUEUE_HYPER);
        ...
        info!("Queue '{}' declared and bound", QUEUE_SYSTEM_HYPER);
