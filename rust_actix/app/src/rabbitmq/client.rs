...
use super::queues::{EXCHANGE_NAME, QUEUE_ACTIX, QUEUE_SYSTEM_ACTIX};
...
impl RabbitClient {
    ...
    pub async fn declare_queues(&self) -> Result<(), Box<dyn std::error::Error>> {
        ...
        info!("Queue '{}' declared and bound", QUEUE_ACTIX);
        ...
        info!("Queue '{}' declared and bound", QUEUE_SYSTEM_ACTIX);
